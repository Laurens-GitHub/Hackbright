...
def most_and_least_common_type(treats):
    ...
    >>> type(most_and_least_common_type(treats))
    <class 'tuple'>
    ...
    >>> treats = [{'type':'dessert'}, {'type': 'drinks'}, {'type':'dessert'}, {'type': 'drinks'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'drinks')

    >>> treats = [{'type':'dessert'},{'type':'dessert'},{'type':'dessert'},{'type':'drink'}]
    >>> most_and_least_common_type(treats)
    ('dessert','drink')
    """
...
def get_treats():
    ...
    >>> get_treats()[0].keys()
    dict_keys(['type', 'description', 'who'])
    """
